## Proyecto 1 : Predicción de Malware (Modelo de Clasificación)
...
assets/img/avproductinstalledtarget.png
![The San Juan Mountains are beautiful!](/assets/images/assets/img/avproductinstalledtarget.png)
